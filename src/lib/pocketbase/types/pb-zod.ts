...
export const PropertiesResponseZodSchema = baseResponseSchema.extend({
  ...
  parking_type: z
    .enum(["", "garage", "carport", "street", "covered", "assigned", "none"])
    .optional(),
  heating: z
    .enum(["", "none", "electric", "gas", "oil", "heat_pump", "solar", "geothermal"])
    .optional(),
...
export const AgentsResponseZodSchema = baseResponseSchema.extend({
  ...
  specialization: z
    .enum(["", "general", "residential", "commercial", "land", "industrial", "mixed"])
    .optional(),
