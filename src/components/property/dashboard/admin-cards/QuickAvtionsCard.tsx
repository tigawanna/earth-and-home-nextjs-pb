        ...
        <div className="flex items-start justify-between gap-2 mb-0.5">
          <div className="flex items-start gap-2.5 min-w-0">
            ...
            <div className="flex-1 min-w-0 space-y-0.5">
              <h3 className="text-[11px] font-medium tracking-wide text-muted-foreground group-hover:text-foreground transition-colors">Quick Actions</h3>
              <p className="text-[10px] text-muted-foreground/80">Common tasks</p>
            </div>
          </div>
          <Button variant="ghost" size="sm" className="gap-1 text-[10px] font-medium hover:bg-primary/10 hover:text-primary h-6 px-2 shrink-0">
