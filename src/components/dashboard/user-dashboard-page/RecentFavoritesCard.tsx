      ...
      <CardContent className="space-y-4">
        {favorites.map((favorite) => {
          const primaryImage =
            ...
            (Array.isArray(favorite.property.images) && favorite.property.images.length > 0
              ? favorite.property.images[0]
              : null);
          const imageUrl =
            primaryImage && typeof primaryImage === "string"
              ? resolvePropertyThumbnailUrl(favorite.property, primaryImage, "64x64")
              : null;
          ...
          return (
            ...
            >
              ...
              <div className="flex-shrink-0 text-right">
                ...
                <p className="text-xs text-muted-foreground">{formatTimeAgo(favorite.created)}</p>
              </div>
            </div>
          );
        })}
